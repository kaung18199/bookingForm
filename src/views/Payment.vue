        ...
        <div class=" col-span-4 ">
          ...
          <div class=" flex justify-center items-center mx-auto my-20">
            <div class=" px-4 py-5 my-6 space-y-8">
              <div class=" ">
                  <p class="text-sm sm:text-base md:text-lg font-medium text-gray-600 flex justify-start item-center "><img src="https://scontent-sin6-3.xx.fbcdn.net/v/t39.30808-6/317742048_138669532307614_7369569818320890056_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeFbtaqcmjqlyDvOTPLnx70KmcGUx5054kaZwZTHnTniRkqP7SvgoUYvrTqA-pbH5W_KX9e4vVIJLYGhSdDbsvNL&_nc_ohc=dGlMejJjPtYAX9NuIB8&_nc_oc=AQk62pb1dlankrCQUEaMa0M-vQd-4QbZfsolYd4rR60NYDMWFl5DelZf4OKSV63T752sczMgyPL-U7E-v5wstqEY&_nc_ht=scontent-sin6-3.xx&oh=00_AfBWYh078cLzqqWb4KveHwMa9nCY8-XFl0vK9HT0Kj-QUQ&oe=6443BCA4" class=" w-8 h-8 mr-4 rounded-full mb-1" alt="">Please, Choose the Payment Type</p>
              </div>
